...
define('CLIENTID', '000000004809C488');
define('CLIENTSECRET', 'ikW5T7uF5RscN6XEtb9u-fM7bvwPHZCJ');
// Make sure this is identical to the redirect_uri parameter passed in WL.init() call.
define('CALLBACK', 'http://jezgra.estudent.hr/modules/login/php/callback.php');
