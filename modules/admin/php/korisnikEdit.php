...
$id=$_GET['id'];	
	...
	header("Location: ../index.php?n=korisnici");
	}	

$baza = new Estudent;
$result = $baza->dohvatiOgranke();
$ogranci = $result->podatci;
$result2 = $baza->dohvatiKorisnika($id);
...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content  default-tab" id="tab1"> <!-- Prvi tab Osnovno -->
           <div clss="formWrap">
                <form class="well" id="urediKorisnika1">
                
                <label class="control-label" for="emailKorisnika" >eSTUDENT mail</label>
             	<div class="input-append">
                <input id="emailKorisnika"  name="emailKorisnika" placeholder="email Korisnika"  
                class="formInput" style="width:200px;" required 
                 value="<?php echo substr($korisnik->email,0,-12);?>" /><span class="add-on" style="margin-bottom:9px; width:90px; height:25px;">@estudent.hr</span>
                </div> 
        ...
        <div class="tab-content" id="tab2"><!-- Drugi tab Lozinka -->
           <div clss="formWrap">
        ...
        <div class="tab-content" id="tab4"><!-- Cetverti tab CV -->
           <div clss="formWrap"> 
           <h3>Jezici</h3>   
           <a href="php/jezikForm.php" rel="facebox">Dodaj jezik</a>   
        <?php if(isset($jezici)){
		...
		?>	
        	<hr>
			<h3>Poslodavci</h3>
            <a href="php/poslodavacForm.php" rel="facebox">Dodaj poslodavca</a> 
        <?php     
			if(isset($poslodavci)){
